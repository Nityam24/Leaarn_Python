...
7968 Why should you learn to write programs? 274

Writing programs (or programming) is a very creative 
and rewarding activity.  You can write programs for 
7503 many reasons, ranging from making your living to solving
...
could 4048 be 4455 very 4361 helpful to us if we only knew the language to
...
from 8276 a 768 piece 4554 of paper is hard for a computer to do 
 8383 but counting the words and telling you how many times 9223
the most used word was used is very easy for the
computer:

Our 6798 personal 8198 information 1960 analysis assistant quickly 
...
6785 that humans are not is why you need to become
...
94 at three Gigahertz, it means that the CPU will ask What next?
three billion times per second.  You are going to have to 
learn 7969 how 9948 to 4752 talk fast to keep up with the CPU.
 218 9860 4473
...
696 screen, keyboard, mouse, microphone, speaker, touchpad, etc.  
...
to 8645 computer 7743 builders, 4382 it helps to have some terminology
...
secondary 3025 memory, 9907 network, 5268 or the input/output devices.
...
738 find it much easier to learn a second programming language such
...
3349 We call this vocabulary the reserved words.  These are words that 9046
...
Before 2457 you 2675 can 6387 converse with Python, you must first install the Python
...
8634 programmers with Python acting as an intermediary.  Python
4914 is a way for the creators of programs to express how the 108
...
5381 The CPU understands a language we call machine language.  Machine
...
9781 programmers to write in high-level languages like Python or JavaScript
and these translators convert the programs to machine language for actual
execution by the CPU.

Since 5697 machine 6753 language 4946 is tied to the computer hardware, machine language
...
(one) 7040 interpreters 9150 and 8816 (two) compilers.
...
2917 Some of the lines of Python tell Python that you want it to remember some 
...
8887 be wondering a bit about the Python interpreter itself.  What language is 3818
...
5854 When you installed Python on your computer (or the vendor installed it), 3174
...
7798 sometimes it pays to answer those little nagging questions right at 
the beginning.
...
7315 from a file, it knows to stop when it reaches the end of the file.
